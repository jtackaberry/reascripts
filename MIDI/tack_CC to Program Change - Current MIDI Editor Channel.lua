--[[
 * ReaScript Name: CC to Program Change - Channel according to MIDI Editor new events channel
 * Description: Converts CC value (based on action binding) to Program Change (bank 32).
...
inject_program_change(0, 32, 0, val)
