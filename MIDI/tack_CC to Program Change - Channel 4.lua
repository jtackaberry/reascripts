--[[
 * ReaScript Name: CC to Program Change - Channel 4
 * Description: Converts CC value (based on action binding) to Program Change (bank 32) on channel 4.
...
inject_program_change(4, 32, 0, val)
